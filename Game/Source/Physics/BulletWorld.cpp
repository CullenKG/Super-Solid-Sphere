...
BulletWorld::BulletWorld(const btVector3 &gravity)
{
    m_pBroadphase = 0;
    ...
    m_pContactListener = new ContactListener(this);
}
...
void BulletWorld::CreateWorld(const btVector3 &gravity)
{
...
void BulletWorld::Update(float deltatime)
{
    ...
    m_pContactListener->Update(deltatime);
}
